...
const HourglassLoader = ({ size = 56, color = '#EF4444' }) => {
  const [hue, setHue] = useState(0);

  // Optional: Add a subtle hue rotation effect
  useEffect(() => {
  ...
  return (
    <div className={styles.loaderContainer} style={{ '--hue': hue, '--size': `${size}px` }}>
      <svg
        aria-label="Loading..."
        role="img"
        height={size}
